...
export default function Post() {
    ...
    return post ? (
        <div className="py-8 w-full md:w-4/5 mx-auto px-1 h-screen ">
            <div>
                <div className="flex justify-center flex-col mb-4  rounded-xl  mx-auto relative">
                    <div className="min-w-md max-w-full h-full min-h-min overflow-hidden mx-auto object-cover relative flex justify-center">
                        <img
                            src={appwriteService.getFilePreview(post.featuredImage)}
                            alt={post.title}
                            className="rounded-sm  h-[20vw]"
                        />
                ...
                <div className="browser-css py-10 text-start dark:text-stone-300 stroke-neutral-900 text-xl md:px-32">
                    {parse(post.content)}
                </div>
                </div>
            </div>
